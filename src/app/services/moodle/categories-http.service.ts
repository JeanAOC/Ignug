...
export class CategoriesHttpService {
  ...
  getAllCategoriesNames(): Observable<CareerModel[]> {
  ...
  create(payload: any): Observable<CategoryModel> {
    const url = `${this.API_URL}`;
    const params = new HttpParams()
    .append('categories[0][name]', payload.name)
    .append('categories[0][parent]', payload.parent.id)
    .append('categories[0][idnumber]', payload.parent.id)
    .append('categories[0][description]', payload.description)
    .append('categories[0][descriptionformat]', '1');
  ...
  update(id: string, payload: any): Observable<CareerModel> {
